...
@Component
@Slf4j
public class TitanOauthAppConf {
    ...
    public static void setRelations(JSONObject relations) {
        TitanOauthAppConf.relations = relations;
    }

    @PostConstruct
    public void init() {
        ConfigFile config = ConfigService.getConfigFile("TitanOauthAppConf" , ConfigFileFormat.JSON);
